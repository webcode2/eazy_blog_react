...
import Divider from "../../components/section_divider";
import illustration from "./../../assets/imgs/illustration.jpg"  
...
function Home() {
      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
            Payments tool for software compenies
          </h1>
          <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
            From checkout to global sales tax compliance, companes around the
            world use Flowbite to simplify their payment stack.
          </p>
          <a
            href=" "
            className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-green-500 hover:text-white rounded-lg bg-primary-700 hover:bg-green-600 border-2 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
          >
            Get started
            <svg className="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>          </a>
          <a
            href=" "
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div className="hover:bg-slate-300 hover:rounded px-6 py-4 bg-slate-50 rounded-md">
          ...
          <div className="hover:bg-slate-200 hover:rounded px-6 py-4 bg-slate-50">
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <div className="hover:bg-slate-300 hover:rounded px-6 py-4 bg-slate-50">
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
...
<section className="bg-white dark:bg-gray-900">
    <div className="gap-8 items-center py-2 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        {/* <img className="w-full dark:hidden" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/cta/cta-dashboard-mockup.svg" alt="dashboard iage"/> */}
        <img className="w-full " 
 src={illustration}    alt="dashboard imge"/>
        <div className="mt-4 md:mt-0">
            ...
            <a href=" " className="inline-flex items-center text-white bg-green-500 hover:bg-green-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                Get started
