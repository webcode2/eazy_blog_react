    ...
    <div className="max-w-5xl mx-auto">
        <div className="flex flex-col items-center md:flex-row">
            ...
            <div className="w-full mt-16 md:mt-0 md:w-2/5">
                <div className="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white rounded-lg border-b-2 border-gray-300 shadow-2xl px-7">
                    ...
                    <div className="block">
                        <button className="w-full px-3 py-4 font-medium text-black rounded-md bg-green-500 ">Log Me In</button>
                    </div>
